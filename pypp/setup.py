...
setup(name = 'hevc',
      ...
      ext_modules = [
        Extension('hevc',
                  sources = ['hevc.pypp.cpp', 'decmain.cpp', 'encmain.cpp'],
                  include_dirs = include_dirs + ['/opt/local/include'],
                  define_macros = define_macros,
                  library_dirs = library_dirs + ['/opt/local/lib'],
                  libraries = libraries + ['boost_python-mt'],
