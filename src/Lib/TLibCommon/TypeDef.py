...
L0363_DU_BIT_RATE                            = 1  # L0363: add bit_rate_du_value_minus1 to HRD parameters
L0328_SPLICING                               = 1  # L0328: splicing support in HRD
L0044_DU_DPB_OUTPUT_DELAY_HRD                = 1  # L0044: Include dpb_output_delay_du_length_minus1 in hrd_parameters(), dpb_output_du_delay in
                                                  #        picture timing SEI and DU information SEI
L0045_PERSISTENCE_FLAGS                      = 1  # L0045: Replace "repetition_period" syntax elements in SEI with "persistence_flag"
L0045_NON_NESTED_SEI_RESTRICTIONS            = 1  # L0045; Include restriction on the order of APS and non-nested BP, PT and DU info SEI messages
L0044_CPB_DPB_DELAY_OFFSET                   = 1  # L0044: Include syntax elements cpb_delay_offset and dpb_delay_offset in the BP SEI message
L0047_APS_FLAGS                              = 1  # L0047: Include full_random_access_flag and no_param_set_update_flag in the active parameter set SEI message
L0043_TIMING_INFO                            = 1  # L0043: Timing information is signalled in VUI outside hrd_parameters()
L0046_RENAME_PROG_SRC_IDC                    = 1  # L0046: Rename progressive_source_idc to source_scan_type
L0045_CONDITION_SIGNALLING                   = 1  # L0045: Condition the signaling of some syntax elements in picture timing SEI message
L0043_MSS_IDC                                = 1
L0116_ENTRY_POINT                            = 1
L0363_MORE_BITS                              = 1
L0363_MVP_POC                                = 1
L0363_BYTE_ALIGN                             = 1
L0363_SEI_ALLOW_SUFFIX                       = 1
L0323_LIMIT_DEFAULT_LIST_SIZE                = 1
L0046_CONSTRAINT_FLAGS                       = 1
L0255_MOVE_PPS_FLAGS                         = 1  # move some flags to earlier positions in the PPS
L0444_FPA_TYPE                               = 1  # allow only FPA types 3, 4 and 5
L0372                                        = 1
SIGNAL_BITRATE_PICRATE_IN_VPS                = 0  # K0125: Signal bit_rate and pic_rate in VPS
L0232_RD_PENALTY                             = 1  # L0232: RD-penalty for 32x32 TU for intra in non-intra slices
...
L0033_RC_BUGFIX                              = 1  # JCTVC-L0033, bug fix for R-lambda model based rate control
...
REMOVE_SINGLE_SEI_EXTENSION_FLAGS            = 1  # remove display orientation SEI extension flag (there is a generic SEI extension mechanism now) 
...
class SaoQTPart(object):
    ...
    def __init__(self):
        self.iBestType      = 0
        self.iLength        = 0
        self.subTypeIdx     = 0 # indicates EO class or BO band position
        self.iOffset        = 4 * [0]
        self.StartCUX       = 0
        self.StartCUY       = 0
        self.EndCUX         = 0
...
class LFCUParam(object):
    ...
    def __init__(self):
        self.bInternalEdge  = False # indicates internal edge
        self.bLeftEdge      = False # indicates left edge
        self.bTopEdge       = False # indicates top edge
